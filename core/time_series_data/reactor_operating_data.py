...
from models.reactor_operating_data import (
    ReactorOperatingData,
    ReactorOperatingDataPoint,
)
...
def add_reactor_operating_data_point(
    reactor_operating_data: ReactorOperatingData, point: ReactorOperatingDataPoint
):
    p = Point(
        measurement="P",
...
def get_points_between_dates(
    reactor_operating_data: ReactorOperatingData,
    start: datetime = None,
    stop: datetime = None,
):
    Time = TimeQuery()
